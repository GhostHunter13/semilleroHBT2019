...
/**
 * Servicio encargado de llamar a los servicios REST de la entidad Persona
 */
@Injectable({
  providedIn: 'root'
})
export class PersonaService extends AbstractService {
  ...
  public consultarPersonas(): Observable<any> {
    return this.httpClient.get('http://localhost:8085/semillero-servicios/rest/GestionarPersona/consultarPersona');
  }
